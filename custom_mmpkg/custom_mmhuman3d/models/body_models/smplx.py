...
from custom_mmpkg.custom_mmhuman3d.core.conventions.keypoints_mapping import (
    convert_kps,
    get_keypoint_num,
)
...
from custom_mmpkg.custom_mmhuman3d.core.conventions.keypoints_mapping.smplx import SMPLX_KEYPOINTS
